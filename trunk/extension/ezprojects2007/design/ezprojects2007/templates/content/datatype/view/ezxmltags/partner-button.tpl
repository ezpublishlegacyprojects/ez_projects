...
{section-else}
    <p>You need to be <a href={"/user/login"|ezurl}>logged in</a> to apply for partnership. If you do not have an user account you may <a href="http://auth.ez.no/user/register">register here</a>.</p>
{/section}
{/let}
