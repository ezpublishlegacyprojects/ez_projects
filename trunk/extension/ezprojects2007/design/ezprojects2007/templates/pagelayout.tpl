...
{set $max_depth=0}
{/if}
{def $rssList=fetch('feeds','subtree_list',hash('node_id',$module_result.node_id, 'max_depth', $max_depth))}
...
<ul>
    {section show=$current_user.is_logged_in|not}
        <li><a href="http://auth.ez.no/user/register">{"Register new user"|i18n( "ezno" )}</a></li>
    {section-else}
