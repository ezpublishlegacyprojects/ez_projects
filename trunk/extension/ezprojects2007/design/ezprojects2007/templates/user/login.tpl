...
<p>Projects.ez.no uses the same user accounts as ez.no. If you don't have an account yet, please <a href="http://auth.ez.no/user/register">sign up</a>.</p>
...
<p><a href="http://auth.ez.no/user/forgotpassword">{"Generate a new password"|i18n( "ezno/user" )}.</a></p>
